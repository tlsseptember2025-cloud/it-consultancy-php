...
<div class="rich-editor-toolbar" aria-label="Description formatting tools">
    ...
    <button type="button" data-editor-command="removeFormat" title="Remove formatting">Tx</button>
                        ...
                        <div
                            ...
                            role="textbox"
                            aria-multiline="true"><?php
                                $storedDescription = $service['description'] ?? '';
                                if (strip_tags($storedDescription) === $storedDescription) {
                                    echo nl2br(htmlspecialchars($storedDescription));
                                } else {
                                    echo $storedDescription;
                                }
                            ?></div>
