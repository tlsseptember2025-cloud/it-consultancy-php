...
class RequestEventHelper
{
    ...
    */
    ...
    public const EVENT_CUSTOMER_CONTINUED_CONSULTATION =
    'CUSTOMER_CONTINUED_CONSULTATION';

    public const EVENT_CUSTOMER_CLOSURE_AGREEMENT_SUBMITTED =
    'CUSTOMER_CLOSURE_AGREEMENT_SUBMITTED';

    public const EVENT_CLOSURE_REQUEST_CONFIRMED =
    'CLOSURE_REQUEST_CONFIRMED';

public const EVENT_CUSTOMER_REQUESTED_RESCHEDULE =
    'CUSTOMER_REQUESTED_RESCHEDULE';

public const EVENT_CUSTOMER_REQUESTED_CANCELLATION =
    'CUSTOMER_REQUESTED_CANCELLATION';

    public const EVENT_CUSTOMER_CONTINUED_CURRENT_APPOINTMENT = 'CUSTOMER_CONTINUED_CURRENT_APPOINTMENT';

    public const EVENT_CONSULTATION_INCOMPLETE = 'CONSULTATION_INCOMPLETE';
    ...
    public const EVENT_CLOSURE_AGREEMENT_APPROVED =
    'CLOSURE_AGREEMENT_APPROVED';

    public const EVENT_CLOSURE_AGREEMENT_REJECTED =
    ...
    public const EVENT_CONSULTATION_REJECTED = 'CONSULTATION_REJECTED';

    public const EVENT_CONSULTATION_COMPLETED = 'CONSULTATION_COMPLETED';

    public const EVENT_MISSED_CONSULTATION_EXPLAINED = 'MISSED_CONSULTATION_EXPLAINED';
    ...
    public const EVENT_PROPOSAL_ACCEPTED = 'PROPOSAL_ACCEPTED';

    public const EVENT_PROPOSAL_REJECTED = 'PROPOSAL_REJECTED';

    public const EVENT_SERVICE_SCHEDULED = 'SERVICE_SCHEDULED';
